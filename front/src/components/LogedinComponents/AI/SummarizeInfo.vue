        ...
        async summarize() {
            ...
            try{
                const response = await openai.chat.completions.create({
                    model: 'gpt-3.5-turbo',
                    messages: [
                        {role: 'system', content: 'You are a specialist summarizing information. You will summarize the news only keeping the most important information. If needes, you can add more information and develop the summary'},
                ...
                this.$emit('assistant-created', { title: 'Summarize Information', content: botReply });
